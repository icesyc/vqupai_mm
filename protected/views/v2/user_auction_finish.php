        ...
        <div class="w_320 mg_auto"><br>
          ...
          <div class="title">
                ...
                <div class="text">
                    ...
                    <div class="float_left box">感谢大家！我们一起努力把原价￥<?php echo $auction['start_price'];?>的“<?php echo $item['title'];?>”杀到了：</div>
                </div>
                <div class="clear"></div>
          </div>
          <div class="price">￥<?php echo $auction['curr_price'];?>元！</div>
        </div>

        <div class="explain">
            <div class="text pd_l10 color_31">现在下载微趣拍，注册就送10元拍券<?php echo $auction['status'];?></div>
